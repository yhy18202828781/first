<?php
	...
	require_once "../../classes/mail/email.class.php";
	//******************** 配置信息 ********************************
	$smtpserver = "smtp.163.com";//SMTP服务器
	$smtpserverport = 25;//SMTP服务器端口
	$smtpusermail = "yhysmart@163.com";//SMTP服务器的用户邮箱
	$smtpemailto = $_POST['toemail'];//发送给谁
	$smtpuser = "yhysmart@163.com";//SMTP服务器的用户帐号
	$smtppass = "Yhy652230";//SMTP服务器的用户密码
